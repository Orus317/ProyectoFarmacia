namespace ProyectoFarmacia
{
    public class CVentas{
        ...
        private ListaEnlazada? _Lista_Productos;
        ...
        public ListaEnlazada Lista_Productos { get => _Lista_Productos; set => _Lista_Productos = value; }
        public string Fecha { get => _Fecha; set => _Fecha = value; }
        public int Monto { get => _Monto; set => _Monto = value; }

        public CVentas(string codigo_Venta, string codigo_cliente, ListaEnlazada lista_Productos, string fecha, int monto)
        {
